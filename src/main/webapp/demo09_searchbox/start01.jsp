...
<body>
	<input class="easyui-searchbox" data-options="menu:'#menu',searcher:doSearch"></input>
	<div id="menu">
		<div data-options="name:'a'">All News</div>
		<div data-options="name:'b'">Sports News</div>
	</div>
</body>
